...
a <- 10
class(a)
# double é um sinonimo
# integer não é um sinonimo. são numeros inteiros. 
...
# começa com as
imdb$data_lancamento
date_lancamento <- as.Date(imdb$data_lancamento)

Sys.Date() - date_lancamento
...
# janitor::clean_names()
janitor::clean_names(iris) #limpar nome das colunas

# comentar a dúvida do Higor
view(mtcars) # só funciona com o tidyverse carregado
...
# Ver para exemplos de importação:
